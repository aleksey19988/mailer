    ...
    public function store(Request $request)
    {
        ...
        $response = $client->chat()->create([
            ...
            'messages' => [
                [
                    'role' => 'user',
                    'content' => 'Напиши вариант поздравления на русском языке. Праздник: ' . $holiday->name . '. Именинника зовут: ' . $employee->first_name . '. Учти, что поздравление должно быть от лица компании Neovox в адрес своего сотрудника, а также учти дополнительные сведения: ' . $request->description . '. Не забудь добавить пару эмодзи во всё поздравление. После первого предложения и перед последним предложением поставь два переноса строки.'
                ],
            ],
        ]);
